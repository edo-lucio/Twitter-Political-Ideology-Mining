...
if __name__ == "__main__":
    input_files = ["data-collection\\data\\scores\\emfd-scoring\\UKLabour-regular.csv", 
                   "data-collection\\data\\scores\\emfd-scoring\\Conservatives-regular.csv"]
    
    output_path = "data-collection\\data\\scores\\emfd-scoring\\filtered" # e.g. data-collection//data//folder_

    # condition
    condition = "followers_count"
    threshold_values = [10000, 3000, 1440, 770, 335, 170, 85]
